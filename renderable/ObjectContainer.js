goog.provide('me.ObjectContainer');
 ...
 */
me.ObjectContainer = function(x, y, width, height) {
...
goog.inherits(me.ObjectContainer, me.Renderable);
 ...
 */
me.ObjectContainer.prototype.sortOn = "z";
/** 
 ...
 * @memberOf me.ObjectContainer
 */
me.ObjectContainer.prototype.autoSort = true;
/** 
 * keep track of pending sort
 * @ignore
 */
me.ObjectContainer.prototype.pendingSort = null;
/**
 * The array of children of this container.
 * @ignore
 */
me.ObjectContainer.prototype.children = null;
/**
 ...
 * @memberOf me.ObjectContainer
 */
me.ObjectContainer.prototype.collidable = true;
 ...
 */
me.ObjectContainer.prototype.addChild = function(child) {
 ...
 * * @param {int} index
 */
me.ObjectContainer.prototype.addChildAt = function(child, index) {
 ...
 */
me.ObjectContainer.prototype.swapChildren = function(child, child2) {
 ...
 * @param {Number} index
 */
me.ObjectContainer.prototype.getChildAt = function(index) {
    if ((index >= 0) && (index < this.children.length)) {
 ...
 * @param {me.Renderable} child
 */
me.ObjectContainer.prototype.getChildIndex = function(child) {
 ...
 * @return {Boolean}
 */
me.ObjectContainer.prototype.hasChild = function(child) {
 ...
 */
me.ObjectContainer.prototype.getEntityByProp = function(prop, value) {
    var objList = [];
 ...
 */
me.ObjectContainer.prototype.removeChild = function(child, keepalive) {
 ...
 */
me.ObjectContainer.prototype.setChildsProperty = function(prop, val, recursive) {
    for (var i = this.children.length, obj; i--, obj = this.children[i]; ) {
 ...
 * @param {me.Renderable} child
 */
me.ObjectContainer.prototype.moveUp = function(child) {
 ...
 * @param {me.Renderable} child
 */
me.ObjectContainer.prototype.moveDown = function(child) {
    var childIndex = this.getChildIndex(child);
 ...
 * @param {me.Renderable} child
 */
me.ObjectContainer.prototype.moveToTop = function(child) {
    var childIndex = this.getChildIndex(child);
    if (childIndex > 0) {
        // note : we use an inverted loop
 ...
 * @param {me.Renderable} child
 */
me.ObjectContainer.prototype.moveToBottom = function(child) {
    var childIndex = this.getChildIndex(child);
 ...
 */
me.ObjectContainer.prototype.collide = function(objA, multiple) {
 ...
 * @return {me.Vector2d} collision vector or an array of collision vector (multiple collision){@link me.Rect#collideVsAABB}
 */
me.ObjectContainer.prototype.collideType = function(objA, type, multiple) {
    var res, mres;
 ...
 */
me.ObjectContainer.prototype.sort = function(recursive) {
 ...
 * @param {type} a
 * @param {type} b
 * @returns {@exp;a@pro;z@exp;b@pro;z|@exp;b@pro;z}
 */
me.ObjectContainer.prototype._sortZ = function(a, b) {
    return (b.z) - (a.z);
};
/**
 * X Sorting function 
 ...
 * @returns {int}
 */
me.ObjectContainer.prototype._sortX = function(a, b) {
    /* ? */
    var result = (b.z - a.z);
 ...
 * @returns {Number}
 */
me.ObjectContainer.prototype._sortY = function(a, b) {
    var result = (b.z - a.z);
 ...
 * @ignore
 */
me.ObjectContainer.prototype.destroy = function() {
 ...
 * @ignore
 */
me.ObjectContainer.prototype.update = function() {
    var isDirty = false;
 ...
 * @returns {undefined}
 */
me.ObjectContainer.prototype.draw = function(context, rect) {
    var viewport = me.game.viewport;
    var isFloating = false;
    this.drawCount = 0;
