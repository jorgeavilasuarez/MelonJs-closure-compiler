 ...
 */
me.event.STATE_PAUSE = "me.state.onPause";
 ...
 */
me.event.STATE_RESUME = "me.state.onResume";
 ...
 */
me.event.STATE_STOP = "me.state.onStop";
 ...
 */
me.event.STATE_RESTART = "me.state.onRestart";
 ...
 */
me.event.GAME_INIT = "me.game.onInit";
 ...
 */
me.event.LEVEL_LOADED = "me.game.onLevelLoaded";
 ...
 */
me.event.LOADER_COMPLETE = "me.loader.onload";
 ...
 */
me.event.LOADER_PROGRESS = "me.loader.onProgress";
 ...
 */
me.event.KEYDOWN = "me.input.keydown";
 ...
 */
me.event.WINDOW_ONRESIZE = "window.onresize";
 ...
 */
me.event.WINDOW_ONORIENTATION_CHANGE = "window.orientationchange";
 ...
 */
me.event.WINDOW_ONSCROLL = "window.onscroll";
 ...
 */
me.event.VIEWPORT_ONCHANGE = "viewport.onchange";
 ...
 * 
 */
me.event.publish = function(channel, args) {
...
me.event.subscribe = function(channel, callback) {
    if (!cache[channel]) {
        cache[channel] = [];
    }
 ...
 */
me.event.unsubscribe = function(handle, callback) {
