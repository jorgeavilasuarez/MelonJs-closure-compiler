 ...
 * @ignore
 * @function
 * @param {number} width  [width="full size of the created canvas"] width of the canvas
 * @param {number} height [height="full size of the created canvas"] width of the canvas
 * init function.
 */
 ...
 * @return {Array.<me.ObjectEntity>} Array of object entities
 */
