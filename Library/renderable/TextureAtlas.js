 ...
 * @ignore
 */
me.TextureAtlas.prototype.format = null;
/**
 * the image texture itself
 * @ignore
 */
me.TextureAtlas.prototype.texture = null;
/**
 * the atlas dictionnary
 * @ignore
 */
me.TextureAtlas.prototype.atlas = null;
/**
 ...
 * );
 */
me.TextureAtlas = function(atlas, texture) {
    if (atlas && atlas.meta) {
        // Texture Packer
...
//goog.inherits(me.TextureAtlas, goog.object);
 ...
 * @returns {Object}
 */
me.TextureAtlas.prototype.initFromTexturePacker = function(data) {
    var atlas = {};
 ...
 * @return {Image}
 */
me.TextureAtlas.prototype.getTexture = function() {
    return this.texture;
};
/**
 ...
 * @return {Object}
 */
me.TextureAtlas.prototype.getRegion = function(name) {
 ...
 */
me.TextureAtlas.prototype.createSpriteFromName = function(name) {
 ...
 * @memberOf me.TextureAtlas
 * @function
 * @param {Array.<String>} names list of names for each sprite
 ...
 * this.anchorPoint.set(0.5, 1.0);		 
 */
me.TextureAtlas.prototype.createAnimationFromName = function(names) {
    var tpAtlas = [], indices = {};
